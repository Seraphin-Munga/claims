...
let dataSource: any;
let ClaimURLAPI = "https://oyster-app-ejs5j.ondigitalocean.app/?format=json";
...
const List: React.FC<any> = () => {
  ...
  const columns: ColumnsType<any> = [
...

    {
      ...
      render: (text, record) => (
        <Space size="middle">
          {/* Show "Edit" button if 'isPaid' is true */}
          ...
          {/* Show "Payment" button if 'review_status' is "Approved" or "Ready For Payment" */}
          {!record.isPaid && (
            <button
